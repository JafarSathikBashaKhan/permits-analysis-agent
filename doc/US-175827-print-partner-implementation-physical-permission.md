# US-175827: Print Partner Implementation | Physical Permission
...
**Folder Structure:** 
Application Container -> print -> Contract ID -> Permission Type -> Permission Name -> Physical Permission -> Send / Receive / Process / success or Failure 
