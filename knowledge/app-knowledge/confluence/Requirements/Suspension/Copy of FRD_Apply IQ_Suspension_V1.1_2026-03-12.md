# Copy of FRD_Apply IQ_Suspension_V1.1_2026-03-12

> **Confluence ID:** 1921220609 · **Version:** 1 · **Last updated:** 2026-04-28T06:39:03.850Z
> **Path:** Requirements / Suspension
> **URL:** https://marston.atlassian.net/wiki/spaces/FF/pages/1921220609/Copy+of+FRD_Apply+IQ_Suspension_V1.1_2026-03-12
...
FRD V1.1 created from BRD v1.1
...
When Map Integration (TRO/TMI/GIS) is enabled, users must select streets and bays from the map, with system‑driven validation for bay availability, overlap, and configuration rules and should select only one street through map
...
When BO user in Apply clicks **Assign Task to CEO**, the system shall show a **Task Creation Popup** with pre-populated

1\. Title,

2.Category=Suspension,

3.  **Location Field**
    

-   Should prepopulate with the **street**.
    
-   If the **Town** field is enabled, it should also prepopulate the **town** in the Location field.
...
-   Should prepopulate with **bay type** and **bay space**.
    
-   Users should be able to add additional comments.
