...
function PreviewCard({ title, body, sub }: { title: string; body: string; sub: string }) {
  return (
    <div style={{ flex: '1 1 300px', border: '1px solid #EDEFF3', padding: 16, borderRadius: 6, background: '#FFFFFF' }}>
      ...
      <Typography sx={{ fontFamily: '"Open Sans", Georgia, serif', fontSize: '1.15rem', fontWeight: 600, mt: 0.75 }}>{body}</Typography>
